- D11 production rotation evidence / shared parity OPEN (2026-09-08):140 native25 build12s221 installed over unchanged main15,1pass33s846; actual layout-space reads preserve original fit assertions. All6 PNGs/current E roots inspected, portrait[0,120][1320,2120], landscape[0,120][2120,1320]. Actual ComponentUtils viewport remains full1320x2120/2120x1320; UiTest visible bounds clip system-bar area. Returned to same Detail and verified original ltr/true/joined in memory and Preferences.141 exported1154frames/33contacts; fresh reviewer7contacts/14originals, root799/800/867/868. Production-only799→800 (35.955233→35.973711) abruptly enlarges/shifts pair;867→868 (41.967156→41.980022) shrinks/shifts pair and reveals an edge strip with monochrome comic content. These observations do not establish shared equivalence or platform causation: shared127 landscape root top0 differs, so direct visual pair rejected. Source-proven missing host connection: ReaderSurface onChromeVisible is not wired by NextEReaderLabPage; ReaderTrialWindow intentionally manages colors only, unlike production fullscreen/chrome visibility synchronization. Next actionable slice: optional host initial/toggle/exit system-bar ownership and exact restoration, then valid same-state rotation comparison. Do not modify core image geometry based on this rejected comparison or replace defaults.237lease20260908-043019-08f0cfc3 released after exports;197 untouched; E product/shared unchanged and no E commit/push.
