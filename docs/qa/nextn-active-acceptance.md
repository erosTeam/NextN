- D11 E HDS-only candidate OPEN (2026-09-08): main13/native13 built14s206/12s675; V1 inventory0/574 and Ehost10 actual-method tests pass. Optional thumbnail captured source style drives both HDS navigation/destination original/scroll style, disables its Window writer, preserves layout source color; ordinary/default reader not migrated.109 installed both packages after diagnostic pilot released237; currentlease20260908-010201-7993a16d.111 native1pass24s518 with hds_source_style#FF000000 and host_clear only; all3 fullPNGs/NextE roots[0,120][1320,2120] inspected.110 continuous frames extraction/review in progress; no return-motion or hidden-color acceptance yet. Shared3925f45 remainsclean; Koma build window returned and197 untouched. Next verify110 lastReader/firstGrid/hidden source, reject candidate if it merely moves the mismatch. RTL parameter/side assertions now compiled in native13 but RTL path not run; E WIP uncommitted.
