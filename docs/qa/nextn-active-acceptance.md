...
- D11 current follow-up 152–155 / motion OPEN: E main17b/native27 and N mainlayoutgate/nativelayoutgate built and installed.152 native1pass27s777;154 native1pass18s796. Root inspected both apps' four full shown/hidden/reshown/closed PNGs and current bundle roots: shown/reshown/closed top120, hidden top0, real P1/P2 retained.153 E993frames/28contacts; independent review14 originals and root823/826 confirm first Detail826(39.237833) already avoids status area, unlike144. However823–825 still show black Reader after dark status content restoration, making time/battery unreadable until Detail; encoded PTS difference68.789ms is not input latency. Reshow809→810 top-chrome shift remains.155 N580frames/17contacts exported; fresh review pending. Shared actual-method32/32 and E/N host12/12 are not motion acceptance. Shared interface checkpoint f4d023f clean; Koma granted one short build/copy window, shared writes and E/N builds held until explicit handback. Next: reconcile155, then implement the source-proven chrome-show ordering correction; exit color handoff and recorded rotation comparison remain OPEN. No default-reader/settings/progress replacement, no E commit,197 untouched.
