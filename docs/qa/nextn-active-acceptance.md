- D11 re-show geometry LIMITED / reader outcome OPEN (2026-09-08): shared3be5ad9 committed optional before-show gate after47 actual-method tests and E/N host17 each.156 N1pass18s605 and158 E1pass26s676, root all8 full PNGs/current bundles inspected (shown/reshown/closed top120, hidden top0).157 N588frames: independent9 originals/root376/378/379; first chrome378(25.084811) correctly inset and stable.159 E998frames: independent12 originals/root804/807/808; first chrome807(35.781233) correctly inset and stable. Both actual pairs stay unchanged. Freeze only named re-show geometry. Exit dark text over black Reader remains N390–391/E818–820; first Detail normal. Next: optional pre-color-restoration host layout callback, preserving the serialized window lease and restoring colors before POP; then fresh hidden Back motion. Pending-close remains method-only; rotation still awaits matched recorded viewport. No default/settings/progress replacement, no E commit,197 untouched. Koma v2 window returned;237 lease20260908-064323-3e56622b.
