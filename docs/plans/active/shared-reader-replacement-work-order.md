...
- **Retained verified evidence baseline:**
  ...
  - reader-kit: pinned commit `8112355` with 63/63 core tests passing (re-run 2026-09-17); all three hosts vendor the identical gitlink `81123559789802cca920756f935594eb3a3336cd` and byte-identical `reader-ui/src/main/ets/ReaderSurface.ets` (sha256 `c685345b…`), confirming one shared core rather than three forks.
