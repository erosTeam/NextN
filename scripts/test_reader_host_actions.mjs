...
assert.match(page, /variantPolicy: new ReaderVariantPolicy\([\s\S]*this\.variantPreference\(sourceIndex\)/)
assert.match(page, /new ReaderVariantPolicy\([\s\S]*this\.handleVariantSelection\(sourceIndex, preference, result\)/)
